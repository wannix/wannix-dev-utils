...
/**
 * Generates a KSUID (K-Sortable Unique Identifier) string.
 * Combines a 4-byte timestamp with 16 random bytes, encoded in Base62 to 27 characters.
 * @returns A 27-character KSUID string
 */
...
/**
 * Generates an array of unique identifiers of the specified type.
 * Supports UUID v4, ULID, and KSUID formats with optional formatting.
 * @param type - The identifier type: 'uuid-v4', 'ulid', or 'ksuid'
 * @param quantity - Number of identifiers to generate
 * @param options - Formatting options (hyphens, uppercase, braces)
 * @returns Array of generated identifier strings
 */
