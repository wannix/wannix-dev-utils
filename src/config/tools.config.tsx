...
export const tools: ToolConfig[] = [
  ...
  },
  {
    ...
    description:
      "Convert between Unix timestamps and human-readable dates for various timezones.",
    icon: Clock,
  ...
  },
  {
    ...
    description:
      "Convert between Spring Boot properties and YAML configuration formats.",
    icon: FileCode2,
  ...
  // Generators
  {
    ...
    description:
      "Convert between JSON and YAML formats with real-time validation and preview.",
    icon: FileJson,
  ...
  // Generation & Building
  {
    ...
    title: "ID Generator",
    description:
      "Generate cryptographically secure UUID v4, ULID, and KSUID identifiers.",
    icon: Fingerprint,
    href: "/tools/uuid",
    iconColor: "text-primary",
    bgColor: "bg-primary/10",
  ...
  },
  {
    ...
    description:
      "Generate cryptographic hashes (MD5, SHA-1, SHA-256, etc.) and HMAC signatures from text.",
    icon: Hash,
    href: "/tools/hash",
    iconColor: "text-primary",
    bgColor: "bg-primary/10",
  ...
  },
  {
    ...
    title: "Cron Tester",
    description:
      "Validate and explain cron expressions with next run previews.",
    icon: CalendarClock,
    href: "/tools/cron",
    iconColor: "text-primary",
    bgColor: "bg-primary/10",
