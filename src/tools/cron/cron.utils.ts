...
/**
 * Computes the next 5 scheduled run times for a cron expression using the croner library.
 * @param expression - The cron expression to evaluate
 * @returns An array of ISO 8601 date strings for upcoming runs
 */
...
/**
 * Parses and validates a cron expression, returning a human-readable description and next run times.
 * Supports standard 5-field, 6-field (with seconds), and 7-field Quartz syntax.
 * @param expression - The cron expression to parse
 * @returns Validation result with description and computed next runs
 */
