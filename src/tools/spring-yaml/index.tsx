      ...
      <div className="flex flex-col h-[calc(95vh-14rem)] min-h-[600px] gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-4">
          ...
          <Button
            onClick={() =>
              handleDirectionChange(
                direction === "prop-to-yaml" ? "yaml-to-prop" : "prop-to-yaml",
              )
            }
          ...
          <Button
            ...
            size="sm"
            onClick={handleClear}
            className="gap-2 w-full sm:w-auto justify-self-end"
          >
        ...
        <div className="grid lg:grid-cols-2 gap-4 flex-1 min-h-0">
          ...
          {/* Output Pane */}
          <Card
            className={`flex flex-col min-h-0 border-border/50 bg-card shadow-sm ${error ? "ring-2 ring-destructive/50" : ""}`}
          >
            <CardHeader className="py-3 px-4 border-b border-border/40 bg-muted/20 shrink-0 flex flex-row items-center justify-between">
              <div className="flex items-center gap-2">
                {isPropToYaml ? (
...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <Button
      ...
      className={
        copied
          ? "h-7 w-7 text-primary hover:text-primary"
