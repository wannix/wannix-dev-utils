...
import { Copy, RotateCcw, Check, Plus, Trash2, Terminal, Play } from 'lucide-react'
...
export default function CurlTool() {
    ...
    const [headers, setHeaders] = useState<Header[]>([{ id: uuidv4(), key: '', value: '' }])
            ...
            <div className="flex flex-col h-[calc(95vh-14rem)] min-h-[600px] gap-6">
                ...
                <Card className="flex flex-col border-border/50 bg-card shadow-sm overflow-hidden flex-1">
                    <CardHeader className="py-3 px-4 border-b border-border/40 bg-muted/20 shrink-0 flex flex-row items-center justify-between">
                        ...
                        <Button variant="ghost" size="sm" onClick={handleClear} className="gap-2 h-8 text-muted-foreground hover:text-foreground">
                    ...
                    <CardContent className="p-6 space-y-6 overflow-y-auto">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <Button variant="ghost" size="sm" onClick={handleAddHeader} className="h-6 gap-1 text-xs">
                        ...
                        {['POST', 'PUT', 'PATCH'].includes(method) && (
                            <div className="space-y-3 pt-2">
                                <Label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Request Body (JSON)</Label>
                                <Textarea
